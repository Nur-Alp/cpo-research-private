# Evidence-integrity audit — 2026-08-09
...
|---|---:|
| Source-log rows | 164 |
| Unique source IDs | 164 |
| Claim-ledger rows | 457 |
| Unique claim IDs | 457 |
...
|---|---:|
| PDF files opened | 69 |
| Total pages opened | 1,081 |
| PDFs with zero pages or extraction errors | 0 |
| Largest retained filing | 146 pages (`FIL-013` CoreWeave FY2025 10-K) |

The claim ledger now has 457 rows with 330 high-confidence, 119 medium-confidence and 8 low-confidence records. “Open” is the workflow status for all claim rows; it does not mean that every claim is unverified. Confidence and evidence boundaries govern how each claim may be used.
