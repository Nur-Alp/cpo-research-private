...
| 5. Manufacturing/yield/reliability/service model | Partial; service/failure-domain model added | Packaging, attach, laser and serviceability benchmarks plus a failure-domain cost model identify the variables and correlated-failure boundary. | Yield waterfall, cycle time, Cpk, field return, warranty and repair-cost data. |
