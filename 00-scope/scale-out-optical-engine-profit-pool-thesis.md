...
The March 2026 NVIDIA agreements with both Coherent and Lumentum materially strengthen the capacity/customer-route evidence for the optical-engine supply chain. They do not, however, identify which products receive the commitments or how much value accrues to a PIC, laser, ELSFP, complete engine or NVIDIA's platform. The investment case therefore shifts from “which supplier has a hyperscaler relationship?” to “which supplier converts that relationship into qualified good devices and protected margin?” [PRI-023–PRI-025; CLM-194–CLM-196]
