...
| Coherent | Coherent demonstrates multiple CPO component paths and says its first six-inch InP line is in volume production with planned expansion; NVIDIA adds a multibillion-dollar purchase/capacity commitment and $2B investment [CLM-068; CLM-069; CLM-194]. Consolidated Q3 FY26 margin is disclosed but is not a CPO margin [CLM-070]. | CPO customer/product allocation, engine ASP, final-engine yield, fibre-attach/test cost, CPO margin, CPO capacity allocation and order conversion. | Use the matched engine bridge; capacity and purchase commitments alone are not usable revenue. |
| Lumentum | Lumentum provides a serviceable ELSFP/UHP-laser product boundary [CLM-071], a multi-channel external-light-source demonstration [CLM-072], and a disclosed incremental multi-hundred-million-dollar CPO order for first-half 2027 delivery; NVIDIA adds a multibillion-dollar purchase/capacity commitment and $2B investment, while Greensboro 6-inch InP capacity is planned for mid-2028 [CLM-083; CLM-195; CLM-196]. Consolidated margin and total-company concentration are disclosed [CLM-073]. | Customer, exact product, quantity, revenue-recognition profile, laser/engine content, CPO margin, yield, warranty, capacity allocation and cancellation protection. | Reconcile order, capacity and fab records with the laser/engine boundary. Planned capacity is not qualified output or gross profit. |
