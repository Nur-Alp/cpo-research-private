...
| Switch-side CPO, 200G/lane Ethernet scale-out | Broadcom documents TH6-Davisson’s 102.4T/16-engine configuration; NVIDIA claims 200G-SerDes CPO switches are in production; CoreWeave claims early Photonics CPO adoption and deployment of the 102.4T SN6600-LD. Broadcom separately reports a 100G/lane TH5-Bailly volume-production baseline with Micas/Delta partner systems. [CLM-076; CLM-077; CLM-079; CLM-199; CLM-200; CLM-220; CLM-221] | 4 — 100G/lane partner-reported volume baseline plus a named customer-side 102.4T deployment claim; 200G/lane volume remains unquantified | A credible integrated CPO product path now has both vendor and customer-side deployment evidence. | Unit count, repeat production, qualification, field reliability, economics or meaningful 200G system adoption share. |
