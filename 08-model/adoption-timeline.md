...
| Switch-side CPO, 200G/lane Ethernet scale-out | Broadcom documents TH6-Davisson’s 102.4T/16-engine configuration; NVIDIA claims 200G-SerDes CPO switches are in production; two CoreWeave pages claim early Photonics CPO adoption and deployment of the 102.4T SN6600-LD in Vera Rubin infrastructure; Celestica reports an unnamed hyperscaler CPO-switch design/manufacturing program with a planned 2027 ramp. Lambda names Spectrum-X Photonics Ethernet only in preparation/roadmap language. Broadcom separately reports a 100G/lane TH5-Bailly volume-production baseline with Micas/Delta partner systems. [CLM-076; CLM-077; CLM-079; CLM-199; CLM-200; CLM-220–CLM-227; CLM-255–CLM-257] | 4 — 100G/lane partner-reported volume baseline plus corroborated named customer-side 102.4T deployment claims and a separate planned 2027 hyperscaler CPO program; 200G/lane fleet volume remains unquantified | A credible integrated CPO product path now has vendor, customer-side deployment, and system-manufacturer program evidence, but Celestica's ramp is planned and Lambda's record does not add Spectrum-X production confirmation. | Fleet size, repeat production, qualification, field reliability, economics or meaningful 200G system adoption share. |
...
| Switch CPO | Customer-side confirmation of a named TH6-Davisson or Spectrum-X Photonics deployment, or conversion of Celestica's hyperscaler program into production | Celestica's planned ramp is 2027, but no observed conversion date is source-supported | Commercial; reliability | Units/ports, customer, service history and repeat order/operating evidence. |
...
| Switch-side CPO, 200G/lane Ethernet | 3–4 | 3–4; Celestica ramp checkpoint planned, no numeric adoption | — | — | — | — | — |
