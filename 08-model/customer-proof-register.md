...
| CoreWeave, `CMP-046`, `CLM-370`–`CLM-372` | Vera Rubin NVL72 operations; Spectrum-X SN6600 scale-out fabric | CoreWeave describes first-provider validation, 100% liquid-cooled SN6600 deployment, 102.4 Tb/s/128-port topology and rack-level service controls | Exact optical/CPO configuration, product revision, unit count, repeat deployment, supplier content and field data; port-count discrepancy with `CMP-022` remains unresolved | **Customer deployment corroboration; CPO attribution and numerator open** |
...
- **Strongest named switch-side deployment:** CoreWeave's Vera Rubin/Spectrum-X records, now including a 100% liquid-cooled SN6600 operational description; the exact SKU configuration, CPO BOM and unit count remain open because the retained records describe both 64 × 1.6T-port and 128-port variants.
