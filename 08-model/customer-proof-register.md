...
| CoreWeave, `CMP-039`, `CLM-320` | Customer/operator co-design; NVIDIA Photonics CPO and Spectrum-X SN6600-LD | CoreWeave describes early Photonics CPO adoption and production-oriented validation, while separately confirming early SN6600-LD deployment | CPO-specific SKU, units, repeat shipments, exact optical BOM, qualification completion and economics | **Stronger customer/operator evidence; CPO numerator still open** |
| CoreWeave/NVIDIA, `CMP-046`–`CMP-047`, `CLM-370`–`CLM-375` | Vera Rubin NVL72 operations; Spectrum-X SN6600 scale-out fabric and official interface manual | CoreWeave describes first-provider validation, 100% liquid-cooled SN6600 deployment and 128-port/800GbE topology; NVIDIA separately documents 128 data interfaces and 64 high-power OSFP ports | Exact physical/logical mapping, CPO configuration, product revision, unit count, repeat deployment, supplier content and field data remain open | **Configuration reconciliation advanced; CPO attribution and numerator open** |
...
- **Strongest named switch-side deployment:** CoreWeave's Vera Rubin/Spectrum-X records, now checked against NVIDIA's official SN6600-LD interface manual. The records expose separate logical/data-interface and high-power physical-port boundaries, but the exact optical SKU, CPO BOM and unit count remain open.
