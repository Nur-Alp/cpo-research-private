...
|---|---|---|---|---|---|
| P0 | Customer-confirmed production SKU, units, ports and deployment date | Broadcom TH6-Davisson; NVIDIA Spectrum-X Photonics | Converts vendor “shipping/production” language into a commercial-proof numerator | Customer filing, named deployment statement, or repeat shipment record identifying CPO configuration | **Partially advanced:** two CoreWeave pages claim early Photonics CPO adoption and deployment of the 102.4T SN6600-LD in Vera Rubin infrastructure, but fleet size, repeat deployments, qualification and exact production date remain undisclosed. `CLM-077`, `CLM-079`, `CLM-220`–`CLM-223`; [switch dossier](../07-companies/broadcom-nvidia-switch-cpo-platform-dossier.md) |
