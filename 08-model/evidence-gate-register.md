...
| P1 | Measured 400G/lane end-to-end link | 400G LPO versus NPO/CPO | Establishes whether the 400G electrical boundary actually forces optics inward | Measured 212.5-GBd/400G lane link, not component-only or modeled data; IEEE objectives now confirm optional 400G C2M/C2C AUI work but still supply no channel-loss budget | `CLM-065`, `CLM-066`, `CLM-067`, `CLM-201`–`CLM-209`, `CLM-326`, `CLM-329`–`CLM-330`; [linear-drive benchmark](../02-architecture/linear-drive-boundary-benchmark.md) |
