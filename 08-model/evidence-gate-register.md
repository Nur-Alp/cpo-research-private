...
|---|---|---|---|---|---|
| P0 | Customer-confirmed production SKU, units, ports and deployment date | Broadcom TH6-Davisson; NVIDIA Spectrum-X Photonics; Celestica hyperscaler CPO program | Converts vendor “shipping/production” language into a commercial-proof numerator | Customer filing, named deployment statement, or repeat shipment record identifying CPO configuration | **Partially advanced:** two CoreWeave pages claim early Photonics CPO adoption and deployment of the 102.4T SN6600-LD in Vera Rubin infrastructure. Celestica separately reports an awarded CPO-switch design/manufacturing program with an unnamed hyperscaler and an expected 2027 production ramp. Broadcom's TH6 release adds HPE, Celestica, Micas and Nexthop partner-route quotations, but no accepted TH6 SKU, units, repeat shipment or field population. `CLM-077`, `CLM-079`, `CLM-220`–`CLM-223`, `CLM-246`–`CLM-249`, `CLM-255`–`CLM-257`; [switch dossier](../07-companies/broadcom-nvidia-switch-cpo-platform-dossier.md) |
...
| P1 | Measured 400G/lane end-to-end link | 400G LPO versus NPO/CPO | Establishes whether the 400G electrical boundary actually forces optics inward | Measured 212.5-GBd/400G lane link, not component-only or modeled data; IEEE objectives now confirm optional 400G C2M/C2C AUI work but still supply no channel-loss budget | `CLM-065`, `CLM-066`, `CLM-067`, `CLM-201`–`CLM-209`; [linear-drive benchmark](../02-architecture/linear-drive-boundary-benchmark.md) |
