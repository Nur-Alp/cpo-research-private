...
| Strategic supplier route | NVIDIA has executed $2B investments and multiyear purchase/capacity agreements with both Coherent and Lumentum.[CLM-197; CLM-198] | Coherent and Lumentum are both credible NVIDIA-linked candidate suppliers | The agreements are nonexclusive/product-unallocated: they do not establish that either company supplies the CoreWeave SN6600-LD, Lambda Quantum-X cluster, Broadcom TH6 or any specified CPO engine | Product allocation, named SKU, qualified share, shipment and price records |
