...
| Strategic supplier route | NVIDIA has executed $2B investments and multiyear purchase/capacity agreements with both Coherent and Lumentum, and its platform page lists a wider technology-partner ecosystem.[CLM-197; CLM-198; CLM-229] | Coherent, Lumentum, TSMC, Corning, Fabrinet, Foxconn, Senko, SPIL, Sumitomo and Browave are candidate ecosystem participants | The agreements and partner list are nonexclusive/product-unallocated: they do not establish who supplies the CoreWeave SN6600-LD, Lambda Quantum-X cluster, Broadcom TH6 or any specified CPO engine | Product allocation, named SKU, qualified share, shipment and price records |
