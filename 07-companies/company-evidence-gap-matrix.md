...
| Customer / qualification evidence | Missing named production CPO customer and repeat units | CoreWeave claims early Photonics CPO adoption and deployment of the 102.4T SN6600-LD; unit count, repeat deployments and qualification remain missing | NVIDIA purchase/capacity agreement claimed; product allocation, qualification and repeat CPO volume missing | NVIDIA purchase/capacity agreement claimed; product allocation, qualification and repeat CPO volume missing | “Several customers” 200G result claimed; names, SKU, qualification and repeat units missing |
