...
**INFERENCE:** NVIDIA has the stronger disclosed full-system route to CPO adoption. Its May 2026 announcement explicitly identifies Spectrum-X Ethernet Photonics as a 200Gb/s-SerDes CPO switch now in production and names CoreWeave, Lambda and Oracle Cloud Infrastructure as first ecosystem partners/adopters. CoreWeave subsequently says it is an early adopter of NVIDIA Photonics co-packaged-optics networking and among the first cloud providers to deploy the 102.4T Spectrum-X SN6600-LD, providing the first reviewed customer-side confirmation of the CPO route.[CMP-019][CLM-220][CLM-221] This still does not disclose unit count, repeat deployments, optical-engine suppliers, qualification, or field-reliability statistics.
...
| Customer evidence | Partner quotations from ecosystem suppliers/integrators; no disclosed customer CPO units or named production deployment | CoreWeave directly claims early Photonics CPO adoption and deployment of the 102.4T SN6600-LD; Lambda/OCI remain named NVIDIA ecosystem partners; Meta confirms Spectrum-X platform use, not photonics/CPO use | Customer-side evidence now confirms a named deployment claim, but no unit count, repeat volume, supplier BOM or field population |
...
Next evidence required: deployed customer SKU and unit count, repeat deployment record, exact CPO optical-engine and laser suppliers, qualification completion, measured chassis power at a matched boundary, field failure/link-flap methodology, engine-replacement procedure, warranty allocation and CPO-specific financial contribution. CoreWeave's record advances the customer-confirmation gate but does not clear its volume or economics conditions.[CLM-220][CLM-221]
