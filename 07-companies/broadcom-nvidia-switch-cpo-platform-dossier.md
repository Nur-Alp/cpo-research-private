...
**INFERENCE:** NVIDIA has the stronger disclosed full-system route to CPO adoption. Its May 2026 announcement and official silicon-photonics platform page identify Spectrum-X Ethernet Photonics as a 200Gb/s-SerDes CPO platform and list multiple first adopters and technology partners. Three CoreWeave records now provide customer/operator corroboration: early Photonics CPO adoption, a 64 × 1.6T-port SN6600-LD description, and a separate 128-port SN6600 operational description with rack-level liquid-cooling controls.[CMP-019][CMP-025][CMP-046][CLM-220][CLM-221][CLM-222][CLM-223][CLM-228][CLM-229][CLM-370][CLM-372] The configuration difference must remain explicit until the exact SKU/revision is reconciled; none of these records discloses fleet size, repeat deployments, optical-engine suppliers, qualification, or field-reliability statistics.
...
| Customer evidence | HPE, Celestica, Micas and Nexthop are named as collaborators or solution-route partners. Celestica separately discloses an unnamed hyperscaler CPO-switch program with an expected 2027 ramp; this is planned program evidence, not shipped TH6 units. TH5 partner production remains a separate 100G/lane baseline | CoreWeave now provides three customer/operator records around Vera Rubin/Spectrum-X, including a 100% liquid-cooled 102.4T SN6600 deployment boundary; Lambda/OCI remain named NVIDIA ecosystem partners; Meta confirms Spectrum-X platform use, not photonics/CPO use | NVIDIA has stronger named customer-side deployment evidence today; the CoreWeave records still do not disclose a reconciled SKU, complete unit denominator, repeat volume, supplier BOM or field population |
