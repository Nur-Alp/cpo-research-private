...
**INFERENCE:** Broadcom has the stronger disclosed merchant-switch CPO product definition. Its TH6-Davisson materials specify a 102.4T switch, sixteen 6.4T optical engines, 200G-per-link operation and field-replaceable ELSFP laser modules. Broadcom also reports a historical 100G/lane TH5-Bailly volume-production baseline with Micas and Delta partner systems. Celestica now separately reports an unnamed hyperscaler CPO-switch design/manufacturing award with a planned 2027 production ramp, and its DS6000 platform is available to initial customers; however, the DS6000 announcement supports both copper and optical interconnects and does not identify the hyperscaler program's SKU or units. The TH6 announcement names HPE, Celestica, Micas and Nexthop as collaborators or solution partners, but these quotations do not disclose a completed TH6 customer deployment or unit count. The TH6 announcement nevertheless describes the 200G device as sampling to early-access customers, despite saying it is “now shipping.”[CMP-018][CMP-028][CMP-029][PRI-028][CLM-199][CLM-200][CLM-246][CLM-247][CLM-248][CLM-249][CLM-255][CLM-256][CLM-257]

**INFERENCE:** NVIDIA has the stronger disclosed platform route to CPO adoption, but the named customer-side switch CPO proof is weaker than previously stated. Its May 2026 announcement and official silicon-photonics platform page identify Spectrum-X Ethernet Photonics as a 200Gb/s-SerDes CPO platform and list multiple first adopters and technology partners. CoreWeave provides a separate early Photonics CPO-adoption statement and SN6600-LD deployment records; NVIDIA's full hardware manual classifies SN6600-LD as a **pluggable RHS-transceiver** switch, not a CPO SKU.[CMP-019][CMP-025][CMP-046][CMP-048][CMP-053][CLM-220][CLM-221][CLM-222][CLM-223][CLM-228][CLM-229][CLM-370][CLM-380][CLM-382][CLM-383][CLM-435][CLM-436] NVIDIA's June production-ramp article adds the clearest public supplier-responsibility map—TSMC, SPIL, TFC and Foxconn—but still does not tie the named partners to a customer-accepted SKU, unit count, final-engine yield or supplier economics.
...
| Customer evidence | HPE, Celestica, Micas and Nexthop are named as collaborators or solution-route partners. Celestica separately discloses an unnamed hyperscaler CPO-switch program with an expected 2027 ramp; this is planned program evidence, not shipped TH6 units. TH5 partner production remains a separate 100G/lane baseline | CoreWeave provides a separate early Photonics CPO-adoption statement, but its named SN6600-LD deployment is confirmed by CMP-048 as pluggable RHS. Lambda/OCI remain named NVIDIA ecosystem partners; Meta confirms Spectrum-X platform use, not photonics/CPO use | NVIDIA has the stronger first-party platform-production route, but no named customer-side Spectrum-X CPO SKU, unit denominator, repeat volume, supplier BOM or field population is currently cleared |
...
7. **CUSTOMER-PROGRAM CLAIM:** Celestica's Q1 2026 release says it received an unnamed hyperscaler award to design and manufacture a CPO Ethernet switch using 1.6T switch silicon, co-packaged optical interconnects and liquid cooling, with production ramp expected in 2027. This is the strongest new Broadcom-route program signal, but it remains a planned ramp without units, SKU, qualification, supplier map or revenue.[CMP-028][CLM-255][CLM-256]
8. **ARCHITECTURE-BOUNDARY FACT:** Celestica's DS6000 platform is available for order to initial customers and supports both copper and optical 1.6TbE interconnects. Its availability therefore corroborates a TH6 customer route but cannot be counted as CPO shipment evidence.[CMP-029][CLM-257]
...
5. **COMPANY CLAIM:** NVIDIA's June 2026 production-ramp article says Spectrum-X Ethernet Photonics is in full production and identifies TSMC, SPIL, TFC and Foxconn as contributors across silicon-photonics fabrication, packaging/assembly/test, laser-module validation and system assembly. It says systems are validated before customer shipment and again names CoreWeave, Lambda and OCI among first adopters. This improves the manufacturing-responsibility map, not the customer-unit or profit evidence.[CMP-053][CLM-435][CLM-436]
...
Next evidence required: deployed customer CPO SKU and unit count, repeat deployment record, exact CPO optical-engine and laser suppliers, qualification completion, measured chassis power at a matched boundary, field failure/link-flap methodology, engine-replacement procedure, warranty allocation and CPO-specific financial contribution. CoreWeave's SN6600-LD records advance a pluggable deployment gate, while its separate Photonics-adopter statement remains unallocated to a CPO SKU.[CLM-220–CLM-223][CLM-380–CLM-384]
...
- `CMP-053`: NVIDIA, [Spectrum-X Ethernet Photonics production-ramp and supply-chain map](../01-sources/product-materials/CMP-053-nvidia-spectrum-x-production-ramp.pdf) · [canonical NVIDIA article](https://blogs.nvidia.com/blog/nvidia-gtc-taipei-computex-2026-news/), June 2026.
...
- `CMP-028`: Celestica, [Q1 2026 results and hyperscaler CPO switch program](https://corporate.celestica.com/static-files/7e777cad-64eb-4ae4-90c7-c715a29d100d), 27 April 2026.
- `CMP-029`: Celestica, [DS6000-series 1.6TbE switches available to order](https://corporate.celestica.com/news-releases/news-release-details/celestica-accelerates-ai-scale-networking-ds6000-series-16tbe), 29 April 2026.
