...
Next evidence required: named customer SKU and units, exact CPO optical-engine and laser suppliers, qualification completion, measured chassis power at a matched boundary, field failure/link-flap methodology, engine-replacement procedure, warranty allocation and CPO-specific financial contribution.
