...
**INFERENCE:** NVIDIA has the stronger disclosed full-system route to CPO adoption. Its May 2026 announcement explicitly identifies Spectrum-X Ethernet Photonics as a 200Gb/s-SerDes CPO switch now in production and names CoreWeave, Lambda and Oracle Cloud Infrastructure as first ecosystem partners/adopters. Two CoreWeave deployment pages independently identify the 102.4T Spectrum-X SN6600-LD in Vera Rubin infrastructure and describe CoreWeave as an early Photonics CPO adopter, providing customer-side corroboration of a named deployment.[CMP-019][CLM-220][CLM-221][CLM-222][CLM-223] This still does not disclose fleet size, repeat deployments, optical-engine suppliers, qualification, or field-reliability statistics.
...
| Customer evidence | Partner quotations from ecosystem suppliers/integrators; no disclosed customer CPO units or named production deployment | Two CoreWeave pages corroborate a named 102.4T SN6600-LD/Vera Rubin deployment; Lambda/OCI remain named NVIDIA ecosystem partners; Meta confirms Spectrum-X platform use, not photonics/CPO use | Customer-side evidence now corroborates deployment, but no unit count, repeat volume, supplier BOM or field population |
