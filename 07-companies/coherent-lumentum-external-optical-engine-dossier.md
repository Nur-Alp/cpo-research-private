...
**INFERENCE:** Lumentum has the clearer narrow product-and-commercial signal for an external laser source: a serviceable ELSFP product boundary, specified UHP/SHP laser demonstrations, a supplier-reported accelerated UHP laser-device programme, a previously disclosed incremental multi-hundred-million-dollar CPO order for delivery in the first half of calendar 2027, and a later initial ELS-module-order statement. The executed March 2026 NVIDIA financing and planned Greensboro 6-inch InP fab strengthen the capacity/customer-route case, but do not prove complete-engine content, yield or margin.[CMP-016][CMP-017][CMP-082][CMP-010][PRI-027][PRI-025][CLM-198][CLM-196][CLM-531][CLM-553–CLM-555]
...
| Commercial signal | **COMPANY CLAIM:** very-high-volume multi-year CPO orders from an unnamed leading AI-data-centre customer; NVIDIA agreement adds a multibillion-dollar purchase commitment | **COMPANY CLAIM:** incremental multi-hundred-million-dollar CPO order for first-half 2027 delivery; a later release cites an initial ELS-module order; NVIDIA agreement adds a multibillion-dollar purchase commitment | Neither disclosure identifies customer/product allocation, price, cancellation terms, margin or shipped CPO units |
...
3. **FACT:** Lumentum reported Q4 FY26 revenue of $1.0063B, GAAP gross margin of 47.4% and non-GAAP gross margin of 50.4%; FY2026 revenue was $3.0140B. These are consolidated financial results and not CPO/ELS margin evidence.[FIL-014][CLM-531]
...
5. **SUPPLIER-REPORTED QUALIFICATION:** Lumentum reports more than 100 million accelerated UHP-laser device-hours across thousands of production devices from multiple fabrication runs, zero reported catastrophic failures, and a 20-FIT rating at 400 mW. The source is a supplier white paper: it does not identify the final ELSFP module, CPO customer/system, field population, module yield, warranty cost, ASP or gross margin.[CMP-082][CLM-553–CLM-555]
...
| Capex and capacity | Reported six-inch InP expansion suggests substantial manufacturing commitment; CPO-specific capex undisclosed | Fab expansion and component capacity support demand; Lumentum reported $284.5M of consolidated nine-month capex versus $177.1M prior year, without CPO allocation [CLM-219] | Use capacity and total-company capex as supply-readiness context, not as incremental CPO capital deployed |
...
The latest primary filings add scale and operating context without clearing the CPO economics gates: Coherent reported $1.806B Q3 FY2026 revenue and 37.7% GAAP gross margin; Lumentum reported $1.0063B Q4 FY2026 revenue and 47.4% GAAP gross margin, and identified an initial ELS-module order. These are consolidated or broad-category disclosures plus an order signal without customer/product/quantity allocation, not CPO-engine revenue, ASP, yield, margin or attributable capacity.[CLM-335][CLM-531]
...
- `CMP-082`: Lumentum, [ELSFP reliability white paper](../01-sources/product-materials/CMP-082-lumentum-elsfp-reliability-white-paper-2026-evidence-note.md), March 2026. Supplier-reported accelerated-device qualification; retained PDF and canonical URL are recorded in the evidence note.
...
- `FIL-014`: Lumentum, [Q4 FY2026 Form 8-K and earnings release](../01-sources/filings/FIL-014-lumentum-q4-fy2026-results-evidence-note.md), furnished 11 August 2026.
